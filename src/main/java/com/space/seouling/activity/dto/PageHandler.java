...
public class PageHandler {
    ...
    public PageHandler(int totalCnt, int page,String search_option,String search_keyword) {
        this.totalCnt = totalCnt;
        this.page = page;
        this.startList = (page - 1) * pageSize;
        totalPage = (int) Math.ceil((double) totalCnt / pageSize);
    ...
    public PageHandler(int totalCnt, int page,String search_option,String search_keyword,int pageSize) {
        this.totalCnt = totalCnt;
        this.page = page;
        this.startList = (page - 1) * pageSize;
        totalPage = (int) Math.ceil((double) totalCnt / pageSize);
    ...
    public PageHandler(String search_option, String search_keyword) {
        this.search_option = search_option;
        this.search_keyword = search_keyword;
    }
}
